...
type RouteId = '/ventures/[slug]/(public)';
...
type LayoutRouteId = RouteId | "/ventures/[slug]/(public)" | "/ventures/[slug]/(public)/ideas" | "/ventures/[slug]/(public)/progress" | "/ventures/[slug]/(public)/sessions" | "/ventures/[slug]/(public)/tasks" | "/ventures/[slug]/(public)/team"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/ventures/[slug]/(public)/+layout.server.js').load>>>>>>;
